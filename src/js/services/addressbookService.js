...
angular.module('copayApp.services').factory('addressbookService', function($log, bitcoreLtz, storageService, lodash) {
  var root = {};

  var getNetwork = function(address) {
    var network;
    network = (new bitcoreLtz.Address(address)).network.name;
    return network;
  };
  ...
  root.add = function(entry, cb) {
    ...
    if (lodash.isEmpty(network)) return cb('Not valid litecoinz address');
