...
angular.module('copayApp.services').factory('configService', function(storageService, lodash, $log, $timeout, $rootScope, platformInfo, bwcService) {
  ...
  var defaultConfig = {
    ...
    download: {
      litecoinz: {
        url: 'https://github.com/LitecoinZ-Community/litecoinz-copay-wallet/releases'
      }
    },
    ...
    rateApp: {
      litecoinz: {
        ios: '#',
        android: 'https://play.google.com/store/apps/details?id=com.litecoinz.wallet',
        wp: ''
      }
    },
    ...
    release: {
      url: 'https://api.github.com/repos/LitecoinZ-Community/litecoinz-copay-wallet/releases/latest'
    },
    ...
    storageService.getConfig(function(err, localConfig) {
      if (localConfig) {
        ...
        if (configCache.wallet.settings.unitCode == 'bit') {
          // Convert to LTZ. Bits will be disabled
