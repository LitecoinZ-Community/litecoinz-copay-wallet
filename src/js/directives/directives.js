...
angular.module('copayApp.directives')
  .directive('validAddress', ['$rootScope', 'bitcoreLtz',
    function($rootScope, bitcoreLtz) {
      return {
        require: 'ngModel',
        link: function(scope, elem, attrs, ctrl) {
          // LitecoinZ address
          var URI = bitcoreLtz.URI;
          var Address = bitcoreLtz.Address
  ...
  .directive('walletSecret', function(bitcoreLtz) {
    return {
      require: 'ngModel',
      link: function(scope, elem, attrs, ctrl) {
        var validator = function(value) {
