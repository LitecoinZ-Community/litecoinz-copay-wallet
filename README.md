...
- Available for [Linux](https://github.com/LitecoinZ-Community/litecoinz-copay-wallet/tags), [Windows](https://github.com/LitecoinZ-Community/litecoinz-copay-wallet/tags) and [OS X](https://github.com/LitecoinZ-Community/litecoinz-copay-wallet/tags) devices.

## Testing in a Browser

> **Note:** This method should only be used for development purposes. When running LitecoinZ Wallet in a normal browser environment, browser extensions and other malicious code might have access to internal data and private keys. For production use, see the latest official [releases](https://github.com/LitecoinZ-Community/litecoinz-copay-wallet/tags).

Clone the repo and open the directory:

```
git clone https://github.com/LitecoinZ-Community/litecoinz-copay-wallet.git
cd litecoinz-copay-wallet
```
...
## LitecoinZ Backups and Recovery
...
Information about backup and recovery procedures is available at: https://github.com/LitecoinZ-Community/litecoinz-copay-wallet/blob/master/backupRecovery.md
...
Finally, in case you lose the device and you have the 24 word seed for the device, you can recover access to your funds using LitecoinZ Wallet, see: https://github.com/LitecoinZ-Community/litecoinz-copay-wallet/blob/master/backupRecovery.md#hardware-wallets
