...
ln -s ../resources/litecoinz/mac/dmg-background.tiff dmg-background.tiff
rm volume-icon.icns
ln -s ../resources/litecoinz/mac/volume-icon.icns volume-icon.icns
...
then
  ...
  export IDENTITY="3rd Party Mac Developer Application: LitecoinZ Community."
