...
# Contributing to LitecoinZ Wallet
...
If you are having particular problem with your LitecoinZ Wallet instalation, please first [search older
issues](https://github.com/LitecoinZ-Community/litecoinz-copay-wallet/issues) in order to learn if the issue is already reported. It could be fixed already.

Please also check our the copay [FAQ](https://github.com/LitecoinZ-Community/litecoinz-copay-wallet/wiki/).
...
provide the following information:
 ...
 - Which version of LitecoinZ Wallet are you using? (Check LitecoinZ Wallet version on the side menu)
 ...
 - Please check LitecoinZ Wallet logs (General Settings -> About LitecoinZ Wallet -> Session Logs). Look for
...
To open an issue go to [Github Issues](https://github.com/LitecoinZ-Community/litecoinz-copay-wallet/issues).
...
Please adhere to the coding conventions used throughout LitecoinZ Wallet (indentation, tests, etc.)
